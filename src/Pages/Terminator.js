...
const Section1 = () => {
    ...
    return(
        <div>
             ...
             <img className="object-contain" src={ ProductsObj[2].Images.Image0}></img>
...
<div className="mx-5">
     ...
     <div>
        <Specifications
         ...
         css ="md:flex-row"
         Image={ProductsObj[2].Images.Image10}
        />
     </div>
     <div>
        <Specifications
         ...
         Image={ProductsObj[2].Images.Image11}
        />
     ...
     <div>
        <Specifications
         ...
         css ="md:flex-row"
         Image={ProductsObj[2].Images.Image12}
        />
...
const Section6 = () => {
    ...
    <img src={ProductsObj[2].Images.Image13} className=""></img>
    
    </div>
    <div className="lg:w-4/12 ">
    <div className="my-1">
    <p className="my-4 text-white">
    <span className="text-3xl  font-bold ">{ProductsObj[2].Name}</span> Specifications
    </p>
...
<div data-aos="fade-up"  class="container py-5">
  <img className="GalleryImg" src={ProductsObj[2].Images.Image0}/>
  <img className="GalleryImg" src={ProductsObj[2].Images.Image7}/>
  <img className="GalleryImg" src={ProductsObj[2].Images.Image8}/>
  <img className="GalleryImg" src={ProductsObj[2].Images.Image9}/>
</div>
